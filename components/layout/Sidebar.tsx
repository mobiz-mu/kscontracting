...
const NAV: NavItem[] = [
  ...
  { label: "Quotations", href: "/sales/quotations", icon: Receipt },
...
function SidebarInner({ inDrawer = false }: { inDrawer?: boolean }) {
  ...
  return (
    <aside
      className={cn(
        // IMPORTANT: use sticky (behaves “fixed” inside your grid, without overlapping content)
          ...
          <div className={cn("flex items-center gap-3", collapsed && "justify-center")}>
            ...
            {!collapsed && (
              <div className="min-w-0">
                ...
                <div className="truncate text-[11px] text-white/60">Admin • Single company</div>
              </div>
            )}
          </div>
        </div>
